    ...
    <footer className="bg-linear-to-r from-green-50 to-blue-50 border-t border-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          ...
          {/* Coluna 3: Contato */}
          <div>
            <h4 className="text-sm font-semibold text-gray-800 mb-3">Fale Conosco</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-center">
                <svg className="w-4 h-4 mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:contato@nutriinfo.com.br" className="hover:text-green-600 transition-colors">
                  contato@nutriinfo.com.br
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:suporte@nutriinfo.com.br" className="hover:text-blue-600 transition-colors">
                  suporte@nutriinfo.com.br
                </a>
              </li>
            </ul>
          </div>
